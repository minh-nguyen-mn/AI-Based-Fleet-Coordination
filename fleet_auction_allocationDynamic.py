...
class DecentralizedAuctioneer:
    ...
    def calculate_local_bid(self, v_row, task, future_tasks, other_idle):
        ...
        # 1. Proximity Utility (Pareto Core)
        # Sufficiently high to compete with Greedy on travel efficiency
        ...
        # Strong linear pull to ensure Pareto dominance on idle metrics
